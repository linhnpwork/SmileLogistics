...
namespace SmileLogistics.DAL
{
	...
	public partial class Agent_Prepaid : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _ConfirmedBy;
		
		private string _JobWorkings;
		...
		private EntityRef<Sys_User> _Sys_User2;
    ...
    partial void OnConfirmedByChanging(int value);
    partial void OnConfirmedByChanged();
    partial void OnJobWorkingsChanging(string value);
    partial void OnJobWorkingsChanged();
    #endregion
		...
		public Agent_Prepaid()
		{
			...
			this._Sys_User2 = default(EntityRef<Sys_User>);
			OnCreated();
		}
		...
		public int UpdatedBy
		{
			...
			set
			{
				...
				{
					if (this._Sys_User2.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ConfirmedBy", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_JobWorkings", DbType="NText NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public string JobWorkings
		{
			get
			{
				return this._JobWorkings;
			}
			set
			{
				if ((this._JobWorkings != value))
				{
					this.OnJobWorkingsChanging(value);
					this.SendPropertyChanging();
					this._JobWorkings = value;
					this.SendPropertyChanged("JobWorkings");
					this.OnJobWorkingsChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sys_User_Agent_Prepaid", Storage="_Sys_User", ThisKey="ConfirmedBy", OtherKey="ID", IsForeignKey=true)]
		public Sys_User Sys_User
		{
			...
			set
			{
							...
							|| (this._Sys_User.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.Agent_Prepaids.Add(this);
						this._ConfirmedBy = value.ID;
					}
					else
					{
						this._ConfirmedBy = default(int);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sys_User_Agent_Prepaid1", Storage="_Sys_User1", ThisKey="AgentID", OtherKey="ID", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sys_User_Agent_Prepaid2", Storage="_Sys_User2", ThisKey="UpdatedBy", OtherKey="ID", IsForeignKey=true)]
		public Sys_User Sys_User2
		{
			get
			{
				return this._Sys_User2.Entity;
			}
			set
			{
				Sys_User previousValue = this._Sys_User2.Entity;
				if (((previousValue != value) 
							|| (this._Sys_User2.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Sys_User2.Entity = null;
						previousValue.Agent_Prepaids2.Remove(this);
					}
					this._Sys_User2.Entity = value;
					if ((value != null))
					{
						value.Agent_Prepaids2.Add(this);
					...
					this.SendPropertyChanged("Sys_User2");
				}
			}
		}
	...
	public partial class Sys_User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Agent_Prepaid> _Agent_Prepaids2;
    ...
    partial void OnIsDeletedChanged();
		...
		public Sys_User()
		{
			...
			this._Agent_Prepaids2 = new EntitySet<Agent_Prepaid>(new Action<Agent_Prepaid>(this.attach_Agent_Prepaids2), new Action<Agent_Prepaid>(this.detach_Agent_Prepaids2));
			this._VehicleTypes = new EntitySet<VehicleType>(new Action<VehicleType>(this.attach_VehicleTypes), new Action<VehicleType>(this.detach_VehicleTypes));
			this._Customer_Prepaids = new EntitySet<Customer_Prepaid>(new Action<Customer_Prepaid>(this.attach_Customer_Prepaids), new Action<Customer_Prepaid>(this.detach_Customer_Prepaids));
			this._CustomerQuotation_Customs = new EntitySet<CustomerQuotation_Custom>(new Action<CustomerQuotation_Custom>(this.attach_CustomerQuotation_Customs), new Action<CustomerQuotation_Custom>(this.detach_CustomerQuotation_Customs));
			this._CustomerQuotation_CustomsDetails = new EntitySet<CustomerQuotation_CustomsDetail>(new Action<CustomerQuotation_CustomsDetail>(this.attach_CustomerQuotation_CustomsDetails), new Action<CustomerQuotation_CustomsDetail>(this.detach_CustomerQuotation_CustomsDetails));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sys_User_Agent_Prepaid", Storage="_Agent_Prepaids", ThisKey="ID", OtherKey="ConfirmedBy")]
		public EntitySet<Agent_Prepaid> Agent_Prepaids
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sys_User_Agent_Prepaid1", Storage="_Agent_Prepaids1", ThisKey="ID", OtherKey="AgentID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sys_User_Agent_Prepaid2", Storage="_Agent_Prepaids2", ThisKey="ID", OtherKey="UpdatedBy")]
		public EntitySet<Agent_Prepaid> Agent_Prepaids2
		{
			get
			{
				return this._Agent_Prepaids2;
			}
			set
			{
				this._Agent_Prepaids2.Assign(value);
			}
		}
		...
		private void attach_Agent_Prepaids2(Agent_Prepaid entity)
		{
			this.SendPropertyChanging();
			entity.Sys_User2 = this;
		}
		
		private void detach_Agent_Prepaids2(Agent_Prepaid entity)
		{
			this.SendPropertyChanging();
			entity.Sys_User2 = null;
		}
