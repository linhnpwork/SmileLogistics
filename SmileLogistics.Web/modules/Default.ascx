<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Default.ascx.cs" Inherits="SmileLogistics.Web.modules.Default" %>
<!-- Page content -->
        ...
        <div class="col-sm-6">
            ...
            <a href="page_comp_charts.html" class="widget widget-hover-effect1">
                <div class="widget-simple">
                    ...
                    <h3 class="widget-content animation-pullDown visible-lg">Latest <strong>Sales</strong>
        ...
        <div class="col-sm-6">
            ...
            <a href="page_widgets_stats.html" class="widget widget-hover-effect1">
                <div class="widget-simple">
                    ...
                    <h3 class="widget-content animation-pullDown visible-lg">Our <strong>Brand</strong>
        ...
        <div class="col-md-6">
            ...
            <div class="widget">
                <div class="widget-extra themed-background-dark">
                    ...
                    <h3 class="widget-content-light">Latest <strong>News</strong>
                    ...
                    <div class="timeline">
                        <ul class="timeline-list">
                            ...
                            <li class="active">
                                ...
                                <div class="timeline-content">
                                    <p class="push-bit"><a href="page_ready_user_profile.html"><strong>eSys_User</strong></a></p>
        ...
        <div class="col-md-6">
            ...
            <div class="widget">
                <div class="widget-extra themed-background-dark">
                    ...
                    <h3 class="widget-content-light">Your <strong>VIP Plan</strong>
            ...
            <div class="widget">
                <div class="widget-advanced widget-advanced-alt">
                    ...
                    <div class="widget-main">
                        <div class="row text-center">
                            <div class="col-xs-4">
                                <h3 class="animation-hatch"><strong>7.500</strong><br>
                                    <small>Clients</small></h3>
                            </div>
                            <div class="col-xs-4">
                                <h3 class="animation-hatch"><strong>10.970</strong><br>
                                    <small>Sales</small></h3>
                            </div>
                            <div class="col-xs-4">
                                <h3 class="animation-hatch">$<strong>31.230</strong><br>
                                    <small>Earnings</small></h3>
                            </div>
                        </div>
                    </div>
                    <!-- END Widget Main -->
            ...
            <div class="widget">
                <div class="widget-advanced">
                    ...
                    <div class="widget-header text-center themed-background-dark">
                        <h3 class="widget-content-light clearfix">Awesome <strong>Gallery</strong><br>
