    ...
    public partial class customers : BasePage
    {
        ...
        private void Delete()
        {
            ...
            using (DALTools dalTools = new DALTools())
            {
                ...
                Customer obj = dalTools.Customer_Get(id);
                if (obj == null)
                {
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                ...
                if (!dalTools.Customer_Delete(obj))
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
                        ErrorCode = 1,
        ...
        private void Edit()
        {
            ...
            using (DALTools dalTools = new DALTools())
            {
                int check = dalTools.Customer_CheckName(data.name.ToString());
                ...
                int result = dalTools.Customer_Update(obj);
                if (result != 0)
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
        ...
        private void Create()
        {
            ...
            using (DALTools dalTools = new DALTools())
            {
                ...
                int result = dalTools.Customer_Create(obj);
                if (result != 0)
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
        ...
        private void LoadList()
        {
            ...
            {
                int totalPages = 0;
                List<eCustomer> all = dalTools.Customer_GetEs(pageIndex, GlobalValues.DefaultPagingSize, out totalPages);
