...
{
    public partial class jobworkings : BasePage
    {
        ...
        private void Delete()
        {
            ...
            using (DALTools dalTools = new DALTools())
            {
                ...
                Job_Working obj = dalTools.Job_Working_Get(id);
                if (obj == null)
                {
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
                        ErrorCode = -1,
                        Message = "Không tìm thấy Mục chi làm hàng!",
                    }));
                ...
                if (!dalTools.Job_Working_Delete(obj))
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
                        ErrorCode = 1,
        ...
        private void Edit()
        {
            ...
            using (DALTools dalTools = new DALTools())
            {
                int check = dalTools.Job_Working_CheckName(data.name.ToString());
                ...
                Job_Working obj = new Job_Working()
                {
                ...
                int result = dalTools.Job_Working_Update(obj);
                if (result != 0)
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
        ...
        private void Create()
        {
            ...
            using (DALTools dalTools = new DALTools())
            {
                ...
                int result = dalTools.Job_Working_Create(obj);
                if (result != 0)
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
        ...
        private void LoadList()
        {
            ...
            {
                int totalPages = 0;
                List<eJob_Working> all = dalTools.Job_Working_GetEs(pageIndex, GlobalValues.DefaultPagingSize, out totalPages);
