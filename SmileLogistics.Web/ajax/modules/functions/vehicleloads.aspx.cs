...
{
    public partial class vehicleloads : BasePage
    {
        ...
        private void Edit()
        {
            ...
            using (DALTools dalTools = new DALTools())
            {
                ...
                int result = dalTools.VehicleLoad_Update(obj);
                if (result != 0)
                    DoResponse(JsonConvert.SerializeObject(new GlobalValues.ResponseData()
                    {
                        Data = null,
        ...
        private void LoadList()
        {
            ...
            {
                int totalPages = 0;
                List<eVehicleLoad> all = dalTools.VehicleLoad_GetEs(pageIndex, GlobalValues.DefaultPagingSize, out totalPages);
